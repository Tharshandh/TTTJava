...
public class TicTacToe implements ActionListener{
	...
	JPanel r_panel = new JPanel(); //restart
	JPanel title_panel = new JPanel();
	JPanel button_panel = new JPanel();
	JLabel textfield = new JLabel();
	JButton[] buttons = new JButton[9];
	JButton r = new JButton("Restart"); // Restart
	...
	public void oWins(int a,int b,int c) {
		buttons[a].setBackground(new Color(40, 130, 0));
		buttons[b].setBackground(new Color(40, 130, 0));
		buttons[c].setBackground(new Color(40, 130, 0));
	...
	public void tie(int a,int b,int c) {
		buttons[a].setBackground(new Color(40, 130, 0));
		buttons[b].setBackground(new Color(40, 130, 0));
		buttons[c].setBackground(new Color(40, 130, 0));
